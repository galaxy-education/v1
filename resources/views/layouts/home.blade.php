...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('home/assets/css/line-awesome.css') }}">
    <link rel="stylesheet" href="{{ asset('home/assets/fonts/fontawesome/fontawesome.css') }}">
    <!--- owl carousel Css-->
    <link rel="stylesheet" href="{{ asset('home/assets/owlcarousel/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('home/assets/owlcarousel/css/owl.theme.default.min.css') }}">
    <!--Preloader Css-->
    <link rel="stylesheet" href="{{ asset('home/assets/css/preloader.css') }}">
    <!--jquery-simple-mobilemenu Css-->
    <link rel="stylesheet" href="{{ asset('home/assets/css/jquery-simple-mobilemenu.css') }}">
    <!--magnific-popup Css-->
    ...
    <!--YouTubePopUp Css-->
    <link rel="stylesheet" href="{{ asset('home/assets/css/YouTubePopUp.css') }}">
    <!--Slick Css-->
...
<body>
            ...
            <div class="moeffect">
                ...
                <div class="fshape3">
                    <svg fill="none" viewBox="0 0 132 199">
                        <circle cx="99.5" cy="99.5" r="98.5" stroke="#fff" stroke-opacity=".05"
                            stroke-width="2" />
                    </svg>
                </div>
                ...
                <div class="fshape5 eitem">
                    <svg fill="none" viewBox="0 0 199 199">
                        <circle cx="99.5" cy="99.5" r="99.5" fill="#0D5FF9" fill-opacity=".05" />
                    </svg>
                </div>
    ...
    <script src="{{ asset('home/assets/js/jquery-simple-mobilemenu.js') }}"></script>
    <!-- imagesloaded.pkgd -->
    ...
    <!-- modernizer JS -->
    <script src="{{ asset('home/assets/js/modernizr-2.8.3.min.js') }}"></script>
    <!-- owl-carousel min js  -->
    <script src="{{ asset('home/assets/owlcarousel/js/owl.carousel.min.js') }}"></script>
    <!-- waypoints -->
    ...
    <!-- YouTubePopUp js -->
    <script src="{{ asset('home/assets/js/YouTubePopUp.jquery.js') }}"></script>
    <!-- yvpopup-active js -->
    <script src="{{ asset('home/assets/js/yvpopup-active.js') }}"></script>
    <!-- scrolltopcontrol js -->
    <script src="{{ asset('home/assets/js/scrolltopcontrol.js') }}"></script>
    <!-- Wow js -->
